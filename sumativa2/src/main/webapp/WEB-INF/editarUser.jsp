	...
	<div class="row">
		...
		<div class="col-md-6">
		   <h1> Editar Usuario </h1>
			...
			<form:form action="/user/actualizar" method="POST" modelAttribute="user">
			 ...
			 <div class="mb-3">
			  ...
			  <div class="mb-3">
			    ...
			    <form:input type="text" path="usuario" class="form-control" aria-describedby="nombreHelp" required="required"/>
			  </div>
			  ...
			  <div class="mb-3">
			    ...
			    <form:input type="text" path="rol" class="form-control"  required="required"/> 
			  </div>
