				   ...
				   <c:forEach var="usuario" items="${lista_usuario}">
			         <tr>
				      <td><c:out value = "${usuario.id}"/></td> 
		  		      ...
		  		      <th scope="row"><a class="btn btn-primary" href="/user/editar/${usuario.id}">Actualizar</a></th>
		  		      <th scope="row"><a class="btn btn-danger" href="/user/eliminar/${usuario.id}">Eliminar</a></th>
